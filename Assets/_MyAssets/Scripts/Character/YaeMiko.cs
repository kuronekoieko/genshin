...
public class YaeMiko : BaseCharacter
{
    ...
    public Dictionary<string, string> CalcDmg(Datas datas)
    {
        ...
        var dmgAdd_skill = datas.add_skill();
    ...
    float GetExpectedDamage(float atk, float talentRate, float dmgAdd, float dmgBonus, float expectedCritDmg, float res, float elementalReaction)
    {
        float dmg = 0;
    ...
    float GetExpectedDamageSum(float atk, float[] talentRates, float dmgAdd, float dmgBonus, float expectedCritDmg, float res, float elementalReaction)
    {
        float dmg = 0;
